            ...
            <div className="container">
                <div className="row">
                    <div className="col text-center">
                        <h5 className="total-case">Total Cases Reported Till : {new Date(lastUpdate).toDateString()}, {new Date(lastUpdate).toTimeString()} </h5>
                    </div>  
                </div>
                <div className="row card-wrapper text-center">
                    <Card className="col col-lg-3 col-md-3 col-sm-12 col-12" >
                        <Card.Body>
                        <Card.Title><h2>{confirmed.detail.split("/").pop()}</h2></Card.Title>
                    ...
                    <Card className="col col-lg-3 col-md-3 col-sm-12 col-12">
                        <Card.Body>
                        <Card.Title><h2>{recovered.detail.split("/").pop()} </h2></Card.Title>
                    ...
                    <Card className="col col-lg-3 col-md-3 col-sm-12 col-12">
                        <Card.Body>
                        <Card.Title><h2>{deaths.detail.split("/").pop()}</h2> </Card.Title>
